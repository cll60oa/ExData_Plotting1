...
par(mfrow=c(2,2))
with(file2_, plot(date_time, Global_active_power,type="l",xlab="",ylab="Global Active Power"))

with(file2_, plot(date_time, Voltage,type="l",xlab="datetime",ylab="Voltage"))
...
with(file2_, plot(date_time, Global_reactive_power,type="l",xlab="datetime",ylab="Global_reactive_power"))
